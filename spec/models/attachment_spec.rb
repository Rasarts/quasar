...
describe AttachmentLink do
  ...
  # validations
  it 'validate presence of master_id' do
    should validate_presence_of :master_id
  end
  
  it 'validate presence of attachment_id' do
    should validate_presence_of :attachment_id
  end
  
  it 'validate presence of attachment_type' do
    should validate_presence_of :attachment_type
  end
  
  it 'validate presence of master_type' do
    should validate_presence_of :master_type
  end

  # asssociations
  it 'belong to *master*' do
